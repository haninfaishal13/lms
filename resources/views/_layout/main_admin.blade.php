    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
            ...
            <!-- Add icons to the links using the .nav-icon class
                ...
                <li class="nav-item">
                    <a href="javascript:void(0)" class="nav-link {{(Request::is('admin/kelas/*')) ? 'active' :''}}">
                        <i class="fas fa-school nav-icon mr-2"></i>
                        <p>Kelas</p>
                    </a>
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('admin.kelas.permintaan')}}" class="nav-link">
                            <i class="fas fa-user-check nav-icon"></i>
                                <p>Permintaan Kelas</p>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="{{route('admin.pelajaran')}}" class="nav-link {{(Request::is('admin/pelajaran/*')) ? 'active' :''}}">
                    <i class="fas fa-book-open nav-icon mr-2"></i>
                    <p>Mata Pelajaran</p>
                    </a>
                </li>
                <li class="nav-item">
