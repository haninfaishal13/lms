            ...
            Route::group(['prefix' => 'admin'], function() {
                ...
                Route::group(['prefix' => 'guru'], function() {
                    ...
                    Route::group(['prefix' => 'permintaan'], function() {
                        Route::get('', [GuruController::class, 'index_permintaan'])->name('admin.guru.permintaan');
                        Route::post('gantiperan', [ChangeRoleController::class, 'store'])->name('admin.guru.permintaan.gantiperan');
                    });
                ...
                Route::group(['prefix' => 'siswa'], function() {
                    ...
                    Route::group(['prefix' => 'permintaan'], function() {
                        Route::get('', [SiswaController::class, 'index_permintaan'])->name('admin.siswa.permintaan');
                        Route::post('gantiperan', [ChangeRoleController::class, 'store'])->name('admin.siswa.permintaan.gantiperan');
                    });
                });
                ...
                Route::get('dt-ganti-peran/{role}', [DatatableController::class, 'dt_gantirole'])->name('admin.dt_gantirole');
